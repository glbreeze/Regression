...
def train_one_epoch(model, images, targets, optimizer, criterion, args):
    model.train()
...
def main(args):
    ...
    train_data_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=False, num_workers=4,
                                   pin_memory=True, persistent_workers=True)
    val_data_loader = DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False, num_workers=4, pin_memory=True,
    ...
    for epoch in range(args.start_epoch, args.max_epoch):
        ...
        all_feats, running_train_loss = train_one_epoch(model, images, targets, optimizer, criterion, args=args)
        scheduler.step()
